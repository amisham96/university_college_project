...
<body>
	...
	<div class="card">
		...
		<div class="card-body">
			<form:form action="/addNewUniversity" method="POST"
				modelAttribute="university">

				<div class="form-group">
					<label for="inputAddress">Enter University Name</label>
					<form:input type="text" path="universityName" class="form-control"
						name="university_name" id="university_name"
						placeholder="Enter University Name" />
				</div>
				<div class="form-group">
					<label for="inputEmail4">Enter University State</label>
					<form:input type="text" path="universityState" class="form-control"
						name="univesity_state" id="university_state"
						placeholder="Karnataka" />
				</div>
				<div class="form-row">
					<div class="form-group col-md-6">
						<label for="inputPassword4">Enter University City</label>
						<form:input type="text" path="universityCity" class="form-control"
							name="university_city" id="university_city"
							placeholder="Enter University City" />
					</div>
					<div class="form-group col-md-6">
						<label for="inputPassword4">Enter University ZIP</label>
						<form:input type="text" path="universityZip" class="form-control"
							name="university_zip" id="university_zip"
