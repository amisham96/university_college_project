...
<link rel="icon" type="image/png"
	href="/resources/images/logo.jpg"
	sizes="32x32">
<link rel="stylesheet"
			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="/universitiesList">List University</a> <a
							class="dropdown-item" href="/universitiesList">Update University</a> <a
							class="dropdown-item" href="/universitiesList">Delete University</a>
					</div>
				</li>
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<div class="dropdown-divider"></div>
						<a class="dropdown-item" href="#">List College</a> 
						<a class="dropdown-item" href="#">Update College</a> 
						<a class="dropdown-item" href="#">Delete College</a>
					</div>
				</li>
			</ul>
